...
urlpatterns=[
    ...
    path('producto', ListarProductos.as_view(), name='listar_prod'), # el pk es el id del proveedor que esta viendo su listado de productos registrados
    ...
    path('producto/guardar_producto', RegistrarProducto.as_view(), name='prod'),#el pk argumento hace referencia al id del mayorista que esta guardando su producto
    ...
    path('registrar_prove', RegistrarProveedor.as_view(), name='reg_prove_mayo'),
