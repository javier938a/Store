...
from .models import tbl_departamento, tbl_municipio, tbl_barrio_canton, tbl_cesta, tbl_sub_categoria1, tbl_sub_categoria2
...
admin.site.register(tbl_sub_categoria2)
